---
title: "Networked Conviction 005"
date: 2026-03-11
tags: ["investing"]
excerpt: "The Flagship Pioneering Model"
slug: "networked-conviction-005"
type: "newsletter"
substack_url: "https://investing101.substack.com/p/networked-conviction-005"
---

<!-- connections-start -->
<aside class="wiki-connections">
  <div class="wiki-connections-label">Wiki Connections</div>
  <div class="wiki-connections-row"><span class="wiki-connections-kind">Essays</span><span class="wiki-connections-items"><a href="/essays/learning-to-dream">Learning To Dream</a>, <a href="/essays/in-defense-of-disney">In Defense of Disney</a>, <a href="/essays/automating-clinical-trials-with-josh">Automating Clinical Trials (with Josh Pacini @ Valinor)</a>, <a href="/essays/networked-conviction-004">Networked Conviction 004</a></span></div>
</aside>
<!-- connections-end -->

![](/images/networked-conviction-005-1-fff88b1b.jpg)

I’ve [written before](https://investing101.substack.com/p/learning-to-dream?utm_source=publication-search) (a [couple of times](https://investing101.substack.com/p/in-defense-of-disney?utm_source=publication-search)) about how much I love Disney. I feel the Spirit of God when I walk down Main Street in Disneyland. Call me a consumerist shill, but I can’t help it! There’s something special about the world building on display there.
...
First, a caveat. I’m not really a biotech investor. I have a couple investments (like [Valinor](https://investing101.substack.com/p/automating-clinical-trials-with-josh?utm_source=publication-search)) that are adjacent. But its not my expertise. So I can’t claim credit for unpacking the model. I have some exceptional investor friends who are more familiar with the playbook whose feet I’ve learned at.
...
Flagship Pioneering was founded in 2000 and, since then, have founded over [~120](https://www.flagshippioneering.com/) companies. In total, they’ve invested in [350](https://pitchbook.com/profiles/investor/11262-52) companies (so not all are founded within their org) and are typically originating ~[6-8](https://pitchbook.com/profiles/investor/11262-52) companies per year.
...
The ultimate source of uncertainty today is AI. Specifically, deployment. From nonsense reports like MIT saying [95%](https://fortune.com/2025/08/18/mit-report-95-percent-generative-ai-pilots-at-companies-failing-cfo/) of enterprise AI pilots failed to more believable reports like S&P Global Market Intelligence saying [42%](https://workos.com/blog/why-most-enterprise-ai-projects-fail-patterns-that-work) of companies abandoned AI initiatives in 2025, or BCG saying [60%](https://www.duperrin.com/english/2025/12/08/impacy-ai-transformation-bcg-mckinsey/) of companies generated “no material value from AI, despite investments.”

What some people see is “AI is fake,” which is the dumbest take. What I see is a clear opportunity.

Similarly, I look at the Anthropic [labor report](https://www.anthropic.com/research/labor-market-impacts) where it showed not places for job displacement, but logical labor augmentation based on current and projected LLM capabilities. The blue areas can *already* be addressed with current AI capabilities. That doesn’t mean they *are* being addressed, just that they could.

![](/images/networked-conviction-005-2-ac495111.jpg)
*Source: [Anthropic](https://cdn.sanity.io/files/4zrzovbb/website/dc7bcd0224644fce97cecb7f9e68dcd8434b35f1.pdf)*
...
Then, I want to think about the structural model. A fund? A holding company? To some extent, this is a continuation of what I wrote about in [Networked Conviction 004: AI Rollups That Don’t Suck](https://investing101.substack.com/p/networked-conviction-004). A holding company model could be a really interesting structure for experimentation. But its not a prerequisite.

## Enter: AI Pioneering

Some high level areas that feel ripe for rapid experimentation of AI’s most applicable surface area:

- **Insurance Underwriting**: Massive pool of human judgement that is shockingly manual. Underwriters at mid-market commercial insurers are still manually reviewing PDFs, pulling OSHA reports, and making gut calls on pricing risk. Commercial P&C represents a $300B+ pool of premiums in the US alone. We have an investment in a company called [Corgi](https://www.corgi.insure/) that is running this playbook right now.
...
- **Mineral Exploration**: The intense pressure for mineral deposits is changing the economic equation here. That, plus advances in geological AI models, make the whale-hunting inherent in the Flagship Pioneering Playbook super interesting. [Atlas Park](https://africa.businessinsider.com/local/markets/dr-congo-signs-ai-powered-mineral-mapping-deal-with-us-firm-atlas-park/xx2b5dl) is doing some really interesting stuff in this category.
