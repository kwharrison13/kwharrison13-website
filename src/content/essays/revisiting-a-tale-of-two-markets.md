...
This past week those 5 top names included [[Snowflake ($SNOW)|Snowflake]], [[MongoDB]], [[Cloudflare]], Samsara, and [[Datadog]]. Some other frequent names in the top 5 include Confluent, [[GitLab]], and [[ServiceNow]].
...
Taking money from a good VC isn't the only way to improve your odds. Every aspect of building a business is about increasing the likelihood of success. Huge credit to [Mark Goldberg](https://twitter.com/Mark_Goldberg_) who I worked with at [[Index Ventures|Index]]. This "do yourself some favors" framework comes almost entirely from him.
...
A number of successful founders have jumped immediately into starting a business. [Elon Musk's early career](https://en.wikipedia.org/wiki/Elon_Musk) is surprisingly similar to a lot of young talented people I talk to these days. Towards the end of school he had two internships (an energy storage research institute and a video game developer), applied for a job at Netscape (1994's [[Alphabet|Google]] APM program), and then decided to start [[Zip2]].

[Dylan Field](https://en.wikipedia.org/wiki/Dylan_Field) is another more recent example. At the age of 20 he became a [[Peter Thiel|Thiel]] Fellow, dropped out of college, and founded [[Figma]], spending 4 years building it before releasing it publicly in 2016. Fast forward to 2021 and Figma is worth $10B.
