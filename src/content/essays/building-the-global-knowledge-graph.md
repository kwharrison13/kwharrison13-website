...
There are a lot of reasons why [**Roam Research**](https://roamresearch.com/) is a good note taking app. Several very smart people have explained how to set up your note-taking productivity brain in Roam across a library of [**videos**](https://www.youtube.com/watch?v=A_7_8AAkV7M), [**articles**](https://www.nateliason.com/blog/roam), [**courses**](https://www.effortlessoutput.com/), [**tweets**](https://twitter.com/kwharrison13/status/1299519854169346050?s=20), and [**crop circles**](https://giphy.com/explore/just-kidding). You’ll see people using Roam for everything from tracking lists of to-dos and groceries to keeping notes on everything they’ve ever read. There is always plenty to learn about using Roam as a personal productivity tool.

But, there is a reason some people [**don’t like to call Roam a note-taking app**](https://twitter.com/kwharrison13/status/1304535470915727360?s=20) and **it’s because they’re dreaming the dream.** You may think [**the simplest vision is a more effective collaborative note-taking app**](https://divinations.substack.com/p/roams-road-ahead) that can more easily sell into enterprise customers. And that’s a good business model to put down on paper.
...
Today Roam is a powerful single-player tool that you can think of as a functional [**reactive coding environment**](https://twitter.com/rroudt/status/1272636471049105408?s=20) for remixing your own thoughts. Use cases extend from grocery lists all the way to conceptual SQL scripts for your ideas.

Co-founder [**Conor White-Sullivan**](https://twitter.com/Conaw) has compared Roam to Excel as both are products with “a low floor and a high ceiling.” You don’t have to start using Excel by using pivot tables. It’s the same product no matter how advanced you are as a user. **But, like with Excel, you get more power out of Roam as you get [better](https://twitter.com/kwharrison13/status/1303682834754723840?s=20) at using it**.
...
But Roam was never built with the vision of being a really great single player product. **Instead, it was built with a much grander vision of allowing users not just to read each other’s public notes but also to** [**remix them**](https://twitter.com/kwharrison13/status/1269072581765656576?s=20).

Imagine a podcast. You have, for example, two guests. One show. And you. That interaction could involve four graphs. [**John Collison and Patrick O’Shaughnessy sit down to create a podcast episode**](http://investorfieldguide.com/collison/). They build the public graph for the episode by contributing from their private graphs. Then you’re able to reference that collaboration into your own graph without losing any context for where those ideas came from.
...
Building a better note-taking app is the software equivalent of building a better mousetrap. The vision for Roam isn’t limited to organizing your information. The grand vision is to organize **all** information.
...
[**Link**](https://twitter.com/Conaw/status/1253445676853125120)
...
### **Roam is the World Wide Web**

[**The internet**](https://en.wikipedia.org/wiki/World_Wide_Web) is a collection of links; websites, subdomains, images, files, video, audio. It’s all links (see the image below on the left). If you’re familiar with Roam’s graph overview, you’re starting to see the similarities (see the image below on the right).



The web is created when you link from one link to another. You can get from one site to another. What you can’t see is all the places that link is being referenced.

But you can with Roam. **Imagine the internet, but with backlinks.** The architecture is already the same. Every domain is a block, every child block is a subdomain. They just need to let you see the links back and forth.



Think of some of the most influential things that have been published online. Let’s take just one as an example: [**the Bitcoin white paper**](https://bitcoin.org/bitcoin.pdf). It’s arguably one of the [**most influential white papers**](https://thatwhitepaperguy.com/most-influential-white-paper/) online and [**has been referenced over 5,000 times**](https://scholar.google.com/scholar?rlz=1C5CHFA_enCA706CA706&um=1&ie=UTF-8&lr&cites=9372423383988544578).



Certainly with things like Google Scholar you can get to an interconnected bibliography. But what if the white paper lived in a public Roam graph and you could see where every block was referenced **in context**?



Now imagine a living breathing Roam graph for the most important collections in the world. Every scrap of research on A.I., cancer drugs, criminal case law, human rights violations, it’s all in a graph that you can reference and see — not just the text but every related backlink and linked reference across other people’s context.
...
So can you use Roam to keep track of your grocery list? Definitely. You can even query the number of times you’ve gotten bananas in the last month. But you’ll have to excuse those of us in the #roamcult that can’t stop talking about Roam eventually building [**The Oasis**](https://twitter.com/Conaw/status/1304949650437201921?s=20) or becoming the [**OS for Neuralink**](https://twitter.com/tylerwillis/status/1251956113139920896?s=20). We’re dreaming the dream of the Global Knowledge Graph.