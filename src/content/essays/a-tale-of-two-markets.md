...
This past week those 5 top names included [[Snowflake ($SNOW)|Snowflake]], [[Cloudflare]], Confluent, [[Datadog]], and Zscaler. Some other frequent names in the top 5 include [[Shopify]], Bill.com, Coupa, Zoom, Crowdstrike, and [[SentinelOne]] with some popping in only for a few weeks (UiPath, nCino, Unity).
...
There's no magic answer. Could be the Fed's [rate hikes that were announced in late 2018](https://www.dw.com/en/us-federal-reserve-hikes-rates-one-more-time-in-2018/a-46809182#:~:text=Meeting%20for%20the%20last%20time,range%20of%202.25%2D2.5%20percent). Similar to the market correction we're experiencing right now investors were forced to really stress test their long term growth assumptions and segment out the best businesses from the average.
...
% change between periods; as of February 4th, 2022
...
This is a super [old school reference](https://en.wikipedia.org/wiki/Videotape_format_war), even for me.
