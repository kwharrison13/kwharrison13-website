...
sources:
  - "~/Downloads/The Anti-Amazon Alliance, (04.28.20).md"
tags: []
aliases:
...
**URL:** https://stratechery.com/2020/the-anti-amazon-alliance/
**One-line:** *Once the Internet made shelf space effectively infinite, discovery and distribution split apart — and an "anti-Amazon alliance" of [Facebook ($META)](/notes/facebook), Google, [Shopify ($SHOP)](/notes/shopify), Stripe and the logistics layer now lets differentiated merchants leave Amazon's platform.*
...
- [Facebook ($META)](/notes/facebook)'s scale **inverts the old advertising game**: instead of moving people down a funnel toward a stocked shelf, advertisers iterate targeting and creative to convert customers immediately.
- Facebook is only one layer of a non-Amazon [E-Commerce](/notes/e-commerce) stack: Facebook finds customers, [Shopify ($SHOP)](/notes/shopify)/WooCommerce build storefronts, Stripe/PayPal handle payments, 3PLs package and ship, and USPS/FedEx/UPS deliver.
...
- The **antidote to an integrator is modularization** — which is why [Shopify ($SHOP)](/notes/shopify), not [Walmart](/notes/walmart), is Amazon's true competitor. Shopify is diversified, so it "succeeds (or fails) in the aggregate."
- Amazon (incl. 3rd-party sales) was ~6% of U.S. retail vs. [Walmart](/notes/walmart)'s ~9% — current e-commerce growth rates won't last forever, especially for physical goods with marginal costs.
...
> **The antidote to an integrator is modularization; that is why I wrote last year that** [Shopify ($SHOP)](/notes/shopify), **not** [Walmart](/notes/walmart), **was Amazon's true competitor.**
...
- The non-Amazon [E-Commerce](/notes/e-commerce) stack:
    - Facebook helps find the customers
    - [Shopify ($SHOP)](/notes/shopify) or WooCommerce build the storefronts
...
- [Shopify ($SHOP)](/notes/shopify) — the modular "anti-integrator" cast as Amazon's true competitor; diversified platform that wins in aggregate.
- [Facebook ($META)](/notes/facebook) — the customer-acquisition layer whose scale inverts the advertising funnel.
- [Amazon](/notes/amazon) — the integrator the alliance forms against.
- [Aggregation Theory](/notes/aggregation-theory) — the lens on how the Internet split discovery from distribution.
- Purchase Funnel — the Edward Strong history of "attention, interest, desire, action."
- [Walmart](/notes/walmart) — the head-on, binary-outcome challenger contrasted with Shopify's diversification.
- Sequel: [Platforms in an Aggregator World](/notes/platforms-in-an-aggregator-world) (Ben Thompson's follow-up a month later).
