---
title: "Why You Should Join Warp"
type: "longform"
format: "article"
publish: true
author: "Eric Zhou and Usman Hanif"
url: "https://whyyoushouldjoin.substack.com/p/warp"
...
aliases:
  ...
  - "Why You Should Join Warp — Eric Zhou and Usman Hanif"
related:
  - "[[Warp]]"
  - "[[Zach Lloyd]]"
  - "[[Eric Zhou]]"
...
**Author:** [Eric Zhou](/notes/eric-zhou) and [Usman Hanif](/notes/usman-hanif)
**URL:** https://whyyoushouldjoin.substack.com/p/warp
**One-line:** *A "Why You Should Join" recruiting/thesis piece on [Warp](/notes/warp) — the Rust-based terminal emulator led by [Zach Lloyd](/notes/zach-lloyd) — arguing the terminal is the most important, least-changed tool in a developer's kit and that Warp is the first to make it accessible, cloud-native, and team-oriented.*

## Key claims

- Software has eaten the world, and as a result, some of the most valuable businesses in the world have been built on the single value proposition of making it easier to write and deploy software.
- Despite this, the most important piece of software in a developer's toolkit hasn't changed in over 40 years: The terminal.
...
- [Warp](/notes/warp) is a Rust-based terminal emulator currently available on MacOS. It's not the first terminal emulator, or even the tenth. But it's the first terminal emulator giving everyone (not just veteran users) terminal superpowers. It's the first terminal emulator designed to leverage the power of the cloud. It's the first terminal emulator designed for teams.
- Even Mike Krieger, the Co-Founder of Instagram, is a fan: he's working on a new startup in stealth, and uses Warp as his daily driver.
...
- Culturally, one tenet Warp prizes amongst its engineers is what their CEO [Zach](/notes/zach-lloyd) calls a "[product-first](https://thezbook.com/code-first-vs-product-first)" mindset. That is, engineers who care about the end product and user experience above everything else, more so than any intrinsic beauty in the code itself.

## Notable quotes

> "The most important piece of software in a developer's toolkit hasn't changed in over 40 years: The terminal… The terminal hasn't changed since 1978, when the VT100 was introduced."

> "It's the first terminal emulator giving everyone (not just veteran users) terminal superpowers. It's the first terminal emulator designed to leverage the power of the cloud. It's the first terminal emulator designed for teams."

> "Warp fills a large gap in the market by providing a terminal that is just as accessible as it is powerful. It will build a long-term advantage by capturing the hearts and minds of the next generation of programmers just as they're starting."

> A "product-first" mindset — "engineers who care about the end product and user experience above everything else, more so than any intrinsic beauty in the code itself."
