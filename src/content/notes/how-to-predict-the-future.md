...
publish: false
author: "Brad Feld"
url: "https://feld.com/archives/2012/06/how-to-predict-the-future/"
source_published: "2012-06"
confidence: "medium"
created: "2026-06-25"
updated: "2026-06-25"
...
aliases:
  ...
  - "How To Predict The Future by Brad Feld"
related:
  - "[[Brad Feld]]"
  - "[[Forecasting]]"
  - "[[Historical Futurism]]"
...
**Author:** [Brad Feld](/notes/brad-feld)
**URL:** https://feld.com/archives/2012/06/how-to-predict-the-future/
**One-line:** *Forecast the timing of non-linear technology disruptions by projecting the smooth, linear hardware trend underneath them — and look at the hardware, not the software.*

## Highlights

_Verbatim excerpts Kyle captured, in source order._

- William Hertling, author of the award-winning [Avogadro Corp: The Singularity Is Closer Than It Appears](https://avogadrocorp.com/) and A.I. Apocalypse, near-term science-fiction novels about realistic ways strong AI might emerge
...
- [Wikipedia](/notes/wikipedia) was a tremendous invention in the process of knowledge curation, and it was dependent, in turn, on the invention of wikis. But it's hard to say, even with hindsight, that we could have predicted Wikipedia, let alone forecast when it would occur.
...
- Calculate the annual increase in a technology trend, forecast the linear trend out, and then map future disruptions to the trend.
- Not everything in life is subject to exponential improvements.
- But it's necessary to distinguish genuine hard limits (e.g. amount of land left to be settled) from the appearance of limits (e.g. manufacturing limits for computer processors).
...
- William Hertling — sci-fi novelist whose near-term AI fiction prompts the piece.
