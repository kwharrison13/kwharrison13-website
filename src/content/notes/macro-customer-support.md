...
**One-line:** *Seed-stage startup (founded/led by [Rami Ghanem](/notes/rami-ghanem)) building a no-code platform for self-serve customer-support flows, so customers resolve their own issues and agents become the last line of defense.*

## What we know

- Founded and led by [Rami Ghanem](/notes/rami-ghanem) (CEO); raising a seed round as of October 2022 (source: October 17th, 2022 — Rami Ghanem (Macro)).
...
- October 17th, 2022 — Rami Ghanem (Macro) — intro + memo.

## Open questions

- Generic-word name; filename/title uses the "(Company)" suffix per the disambiguation convention, with "Macro" kept as an alias.
