...
url: "https://fs.blog/knowledge-project/naval-ravikant/"
source_published: "2017-04-11"
confidence: "high"
created: "2026-06-22"
updated: "2026-06-22"
...
**Author:** [Naval Ravikant](/notes/naval-ravikant) (interviewed by [Shane Parrish](/notes/shane-parrish))
**Show:** The Knowledge Project, Ep. #18
**URL:** https://fs.blog/knowledge-project/naval-ravikant/
**One-line:** *[Naval Ravikant](/notes/naval-ravikant) on reading as a daily habit, happiness as the absence of desire, the "single-player game" of self-improvement, why macroeconomics is junk science but microeconomics is fundamental, the obsolescence of one-size-fits-all education, and investing as a portfolio of options rather than a checklist.*
...
- The good stuff is **old as hell**: read [Adam Smith](/notes/adam-smith) and [The Wealth of Nations](/notes/the-wealth-of-nations), [Benjamin Franklin](/notes/benjamin-franklin)'s aphorisms, [Charlie Munger](/notes/charlie-munger), [Charles Darwin](/notes/charles-darwin) (evolution at the source), Watson and Crick. Instead people read the airport #1 bestseller, or "100 regurgitated books on evolution and they've never read Darwin." Macroeconomists who've read tons of treatises but no Adam Smith.
...
- [Warren Buffett](/notes/warren-buffett)'s inner-vs-outer scorecard: **"do you want to be the world's best lover and known as the worst, or the world's worst lover and known as the best."** All the real scorecards are internal. (Cited via [Shane Parrish](/notes/shane-parrish).)
...
- **microeconomics and [Game Theory](/notes/game-theory) are fundamental** — you can't succeed in business or modern capitalist society without a strong grasp of supply and demand, labor vs. capital, and game theory.
...
- You don't reform a broken system by reworking it — you create something brand new. Naval's fantasy project (post-[AngelList](/notes/angellist)): a **very low-cost, rugged, cheap Android tablet** distributed worldwide with pre-built learning apps that boot in 30 seconds, detect your language and aptitude per discipline, and adapt the pace to each child — networking all the teachers and students of the world (beyond just Salman Khan / [Khan Academy](/notes/khan-academy)). Inspired by the story of unopened Android tablets left in a Pakistan village: months later the kids had hacked them to root, installed apps, set up a little economy, taught younger kids and grandmothers, and taught themselves English. **"Kids are learning machines, they just need the tools."**
...
- **No checklist system for decisions.** [Atul Gawande](/notes/atul-gawande)'s The Checklist Manifesto is "good for pilots and surgeons, not necessarily for investors" — and "that's another one of those books where you read the first chapter and you're done; it would have been a great blog post."
...
### [Charlie Munger](/notes/charlie-munger)'s three rules (cited by Naval)
...
- [Naval Ravikant](/notes/naval-ravikant) — the speaker; this episode is a canonical source for his views on reading, happiness, and learning.
- [Shane Parrish](/notes/shane-parrish) — interviewer; surfaces the [Warren Buffett](/notes/warren-buffett) inner/outer-scorecard framing.
- Self-Guided Learning / [Reading](/notes/reading) — the desire-to-learn-is-the-scarce-resource thesis.
- [Happiness](/notes/happiness) / [Intrinsic Motivation](/notes/intrinsic-motivation) — happiness as the absence of desire and a single-player game.
- [Charlie Munger](/notes/charlie-munger) / The Checklist Manifesto / [Atul Gawande](/notes/atul-gawande) — Naval's stance on checklists and reading the source.
- macroeconomics vs microeconomics / [Game Theory](/notes/game-theory) — the macro-is-junk / micro-is-fundamental distinction.
- [AngelList](/notes/angellist) — the portfolio-of-options investing system in practice.
