...
sources:
  ...
  - "wiki/meetings/December 15th, 2022 — Kat Orekhova (Vareto).md"
...
- **[Adaptive Planning](/notes/adaptive-planning)** — proven at scale (public-company customer lists) but outdated UI, analyst-heavy data entry, "no one gets fired for using Adaptive." Deeper on advanced headcount/scenario planning.
- **[Cube Software](/notes/cube-software)** — marginal step up from spreadsheets; seamless because you keep living in the spreadsheet; per-integration pricing.
- **[Pigment](/notes/pigment)** — powerful, but interface less streamlined; harder to bring business partners in.

## Company / fundraising

Per Kat's Dec 2022 update: strong inbound investor interest (GV, Menlo Ventures cited as great partners), targeting ~$1–2M ARR by spring 2023 to prove sales beyond founder-led, with a raise planned around March/April 2023.
