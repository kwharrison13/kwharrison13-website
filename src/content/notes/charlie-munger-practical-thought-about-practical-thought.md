...
- Third, with so much success coming, we must avoid bad effects from Envy, which is given a prominent place in the Ten Commandments because envy is so much a part of human nature. The best way to avoid envy, recognized by [Aristotle](/notes/aristotle), is to **plainly deserve the success we get.** We will be fanatic about product quality, quality of product presentation, and reasonableness of prices, considering the harmless pleasure we will provide.
