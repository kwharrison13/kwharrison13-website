...
- Integrated into CI/CD pipeline — everything is linked so developers are aware; held up as the model for how API security alerts should be delivered to developers. ([David Mark](/notes/david-mark), Salt Security Diligence — 2021)
...
- CI/CD — Snyk's integration point
