...
**One-line definition:** *An in-app micro-survey and product-research platform (formerly **UserLeap**) whose wedge is contextual, SDK-native surveys served inside a product flow, plus the ability to take open-ended responses and categorize them automatically.*
...
- Customers named: Robinhood, Square, Nike, Figma. Funded by [a16z](/notes/a16z) (Series B), [Accel](/notes/accel) (Series A), [Bill Trenchard](/notes/bill-trenchard) / First Round (seed).
...
- Sprig fka UserLeap - Diligence — full VC diligence (four expert calls).
