...
<!-- key-takeaways -->
_Light-engagement read; no marginalia to synthesize. The 54 highlights below stand on their own as the source's argument._

An anthology edited by [Ronald Rice](/notes/ronald-rice) in which 84 writers each profile their favorite independent bookstore. Across the essays a single brief recurs: the indie bookstore as the anchor of a community — "the cultural soul of a large community," what one contributor calls "what's left of [The Commons](/notes/commons)" — set against the frictionless convenience of Amazon and the Kindle. The physical book as a "material artifact… to be held and smelled" is defended repeatedly, alongside the argument that where you spend money is a civic act, not just a consumer one. Recommended to Kyle at [Dog Eared Books](/notes/dog-eared-books) (a fitting acquisition — a bookstore book bought at a bookstore).
<!-- /key-takeaways -->

## Connections

<!-- interconnections -->
- [What I Found in a Thousand Towns](/books/what-i-found-in-a-thousand-towns) — Dar Williams' case that local gathering places knit a town together; the same "proximate space" argument the bookstore essays make, and both flag the big-box hollowing of Main Street.
- [Our Towns](/books/our-towns) — the Fallowses' town-by-town survey; My Bookstore's contributors echo their lament over "the crushing sameness of the spaces between cities and towns," with the independent store as a marker of a place worth living in.
- [How To Read a Book](/books/how-to-read-a-book) — Adler & Van Doren on reading as an active discipline; the counterpart to My Bookstore's defense of the book as a physical object "to be held and smelled, containing language that can be touched, and underlined with an actual pencil."
<!-- /interconnections -->
