...
1. **The product becomes the center of gravity.** In a Product Led Growth (PLG) company "the first interaction with your company or product is typically through the product itself" — sales and marketing don't even enter until after. Every function reorganizes around supporting the product team, and the website and signup flow get treated as *part of the product*, not a separate funnel.
...
6. **Measure leading indicators, and be skeptical of NPS.** The notes lean hard on OpenView's benchmarking: the fastest-growing SaaS companies hit 89% logo and 109% net-dollar retention, and the top decile retains ~20% better than the median — with most churn decided *in the first week*, which makes Onboarding the lever. Meanwhile Net Promoter Score is "not very predictive" of retention (10 NPS points ≈ 0.9% logo / 0.55% NDR), so track *actual* referrals and product stickiness instead. A sharp org lesson: making [Net Revenue Retention](/notes/net-revenue-retention) one team's North Star let every other team off the hook — better to be the "champion" than the "owner."

7. **PLG reshapes the org chart and the budget.** Freeing spend from sales let SendGrid put 25%+ of revenue into R&D (vs. 15% at CA) and run a 6:1 engineer-to-PM ratio (vs. 20:1). The "traditional product management method is broken"; every PM should work from a growth mindset, and pricing deserves its own dedicated function.
...
<!-- interconnections -->
- [The Lean Startup](/books/the-lean-startup) — the minimum viable product / [Experimentation](/notes/experimentation) spine of PLG: "release an MVP and then focus on evolving it," test the *negative* hypothesis, and treat data and an experimentation-driven mindset as core ingredients.
- [Zero To One](/books/zero-to-one) — the counterpoint on Distribution: PLG bets the product is its own distribution channel ("de-labor the distribution engine"), where Thiel argues distribution is a deliberate, under-respected discipline in its own right.
<!-- /interconnections -->
...
- "**Power is shifting away from executive buyers and we're seeing the rise of the individual user.** You've heard this trend called a number of things, both positive ([Consumerization of the Enterprise](/notes/consumerization-of-the-enterprise)) and negative ('Shadow IT')."
- "Product Led Growth (PLG) — where the product is front and center in how a company acquires, converts and expands users — offers the potential for disruptive growth by championing the user, not just the buyer."
...
- "**'The consumerization of the enterprise is largely a failed promise to date, and it's certainly not for a lack of effort. It's just a really hard problem to solve.'**" — Andrew Reed at [Sequoia](/notes/sequoia) _(as of Aug. 5th 2019)_
...
- "If your end users live in Chrome, distribute through the Chrome Web Store. If they live in Slack, distribute through the Slack App Directory. If they live on their smartphone, distribute through the App Store. **You get the idea: multiple screens, multiple distribution channels.**" _(see Distribution)_
