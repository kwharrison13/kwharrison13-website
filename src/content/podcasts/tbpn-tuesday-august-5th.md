...
episode_date: "2025-08-05"
source: "youtube"
url: "https://www.youtube.com/watch?v=3bbn6SzNZD8&t=8999s"
youtube_id: "3bbn6SzNZD8"
image: "/images/podcasts/tbpn-tuesday-august-5th.webp"
slug: "tbpn-tuesday-august-5th"
confidence: "medium"
created: "2026-07-12"
updated: "2026-07-12"
...
_Lightly cleaned for readability (speech-to-text artifacts corrected, names normalized). TBPN, Tuesday, August 5th, 2025._

**Host:** Anyway, we have our next guest in the Temple of Technology — Kyle from [Contrary](/notes/contrary). How you doing, Kyle? Good to see you. Welcome to the stream.
...
**People**
- John Coogan & Jordi Hays — the [TBPN](/notes/tbpn) hosts.
- [Elon Musk](/notes/elon-musk) — the founder-mode archetype; Kyle's contrast case for visionary leadership and the [Tesla](/notes/tesla) investor base.
- [Jensen Huang](/notes/jensen-huang) — the counter-example to Lip-Bu Tan: "night and day difference" in visionary chip leadership.
...
- [Palmer Luckey](/notes/palmer-luckey) — "prickly porcupine" line on Taiwan; source of the "Wall Street Weenies" framing.
- [Alex Karp](/notes/alex-karp) — the "Karp on the mic" benchmark for inspiring public-company leadership.
- Dylan Patel — SemiAnalysis; cited on Intel Foundry's survival being critical to US dominance.
- [Jack Welch](/notes/jack-welch) — the financialization / buyback-over-R&D playbook Kyle blames for Intel's lost lead.

**Companies**
- [Contrary](/notes/contrary) / [Contrary Research](/essays/contrary-research) — Kyle's fund and its private-markets research database; publisher of the American-TSMC deep dive.
- [Intel](/notes/intel) / Intel Foundry — the piece's central bet for sovereign leading-edge capacity.
- [TSMC](/notes/tsmc) — the incumbent to emulate, borrow from, or buy; $165B US investment; Arizona fabs.
- [Samsung](/notes/samsung) — alternative fab expansion; Musk's deal and floor-walking.
- [Nvidia](/notes/nvidia) — scale benchmark (Intel has more employees than TSMC and Nvidia combined).
- [Anduril](/notes/anduril) — on-the-ground defense partner in Taiwan.
- [Palantir](/notes/palantir), [Tesla](/notes/tesla), [SpaceX](/books/elon-musk-tesla-spacex-and-the-quest-for-a-fantastic-future) — Karp's / Musk's companies as leadership + investor-base references.
...
- [American Dynamism](/notes/american-dynamism) / [Investing in American Dynamism](/notes/investing-in-american-dynamism) / [Building American Dynamism](/notes/building-american-dynamism) — the reshoring-for-national-interest lineage this sits in.
- [Financialization](/notes/financialization) — the buyback-driven decline Kyle diagnoses at Intel.
- [AGI](/notes/agi) — the compute frontier leading-edge nodes are needed to compete on.
- [Apple Earnings, An Interview with Jay Goldberg About Chips and Intel](/notes/apple-earnings-an-interview-with-jay-goldberg-about-chips-and-intel) — companion long-read on chips and Intel.
