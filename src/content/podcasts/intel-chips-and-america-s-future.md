---
title: "Intel, Chips, and America's Future"
type: "podcast"
format: "podcast"
category: "appearance"
role: "guest"
...
show: "Riskgaming"
host: "Danny Crichton"
episode_date: "2025-08-13"
source: "apple"
url: "https://podcasts.apple.com/us/podcast/intel-chips-and-americas-future/id1615629580?i=1000721832806"
image: "/images/podcasts/intel-chips-and-americas-future.jpg"
slug: "intel-chips-and-america-s-future"
confidence: "high"
created: "2026-07-12"
updated: "2026-07-12"
last_updated_by: "agent"
sources:
  - "https://www.riskgaming.com/p/intel-chips-and-americas-future"
tags:
  - "podcast"
  - "semiconductors"
  - "intel"
...
aliases:
  ...
  - "Intel, chips and America's future"
  - "Building an American TSMC (Riskgaming)"
related:
  - "[[Intel]]"
  - "[[TSMC]]"
  - "[[Contrary Capital]]"
...
The through-line: **[Intel](/notes/intel) is America's only remaining shot at cutting-edge chip fabrication**, and it is a waning one. Kyle argues Intel's decades of strategic misses — passing on Arm and mobile, ceding contract manufacturing to [TSMC](/notes/tsmc), missing AI silicon and [Nvidia](/notes/nvidia), sitting on early EUV and high-NA EUV leads — left it hollowed out by the same Jack-Welch-era [stakeholder capitalism](/notes/stakeholder-capitalism) that gutted [General Electric](/notes/general-electric) and [Boeing](/notes/boeing). What makes chips different from those parallels is that fabrication is the **foundational building block of cutting-edge AI**, a resource that is uniquely self-replenishing (better AI builds better AI), arriving exactly as tensions with [China](/notes/china) over Taiwan peak.

From there the two widen out to the hard problems underneath: why **creative destruction breaks down** when barriers to entry run to tens of billions and [ASML](/notes/asml) EUV machines cost a quarter-billion each; why **ecosystem and tacit, apprentice-based knowledge** (shipbuilding, steel, chips) can't be rebuilt from a textbook once a generation is lost; whether reindustrialization is possible today the way Freedom's Forge describes for WWII (Kyle: yes in spirit, but "uncomprehensibly more complex"); and the **information commons / cognitive security** crisis — Kyle's stated bigger fear than industrial complexity: that a maximally manipulable society loses the capacity to rally.

The back half turns to **hype as currency** — the [Warren Buffett](/notes/warren-buffett) "voting machine vs. weighing machine" frame, [Tesla](/notes/tesla)'s narrative-tolerant investor base, and the worry that [OpenAI](/notes/openai) / [Anthropic](/notes/anthropic) / Perplexity / Cursor can kick an unsustainable business model down the road so long that the weighing never happens (the "never-ending con" and "green bubble 2.0" capital-destruction risk). It closes on Kyle's optimistic thesis: the technological distribution curve — distributing existing technology to the long-tail of use cases (ChatGPT was "a distribution breakthrough, not a technological one") — provided America first secures the right to exist by maintaining at least **parity** with China.
...
**The report**
- **Building an American TSMC** — the [Contrary Research](/essays/contrary-research) report by Kyle and Maxx Yung that anchors the episode. The frame throughout: [Intel](/notes/intel) is America's "only hope, and that is a waning hope" for domestic cutting-edge fabrication.

**Companies & institutions**
- [Intel](/notes/intel) — the last US company still manufacturing its own leading-edge chips; missed Arm/mobile, contract manufacturing, [Nvidia](/notes/nvidia) (a ~$20B acquisition shot down by shareholders), and sat on early EUV leads. Intel Foundry → "America's foundry" is Kyle's proposed fix.
- [TSMC](/notes/tsmc) · [Samsung](/notes/samsung) · SK Hynix — the foundry leaders Intel ceded ground to; none showing cultural cracks.
- [Nvidia](/notes/nvidia) — crossed 8% of the S&P 500 the morning of the recording; the AI-silicon winner Intel missed.
- [ASML](/notes/asml) — sole supplier of EUV / high-NA EUV lithography machines (~quarter-billion dollars each); the physical barrier to entry.
- SMIC · Yangtze Memory — China's next-generation foundries; the state-directed-capitalism playbook applied to chips after photovoltaics and electric vehicles.
- [Anduril](/notes/anduril) — Contrary's research subject for manufacturing; Arsenal-1 as a model of single-location, garage-tooling production. Cited with [Palantir](/notes/palantir) and [SpaceX](/books/elon-musk-tesla-spacex-and-the-quest-for-a-fantastic-future) as proof complex production can scale "in spite of the paradigm."
- [General Electric](/notes/general-electric) / [Jack Welch](/notes/jack-welch) · [Boeing](/notes/boeing) — the hollowed-out-by-[stakeholder capitalism](/notes/stakeholder-capitalism) parallels; Boeing the closest analog (lose airframe manufacturing → lose the industry).
- [Tesla](/notes/tesla) · [Elon Musk](/notes/elon-musk) — the narrative-tolerant investor base as Musk's most impressive build (via Bucco Capital).
- [OpenAI](/notes/openai) · [Anthropic](/notes/anthropic) · Perplexity · Cursor — "fundamentally unsustainable business models" kept aloft by hype; Stargate and [ChatGPT 5](/notes/chatgpt)'s efficiency turn discussed.

**People**
- Danny Crichton — host, [Lux Capital](/notes/lux-capital) / Riskgaming.
- Maxx Yung — report co-author.
- Craig Barrett — former Intel CEO; his blueprint piece calling Intel's "14A begging for help" a cop-out.
- [Warren Buffett](/notes/warren-buffett) — "voting machine / weighing machine."
- Kyla Scanlon — attention economics.
- [Byrne Hobart](/notes/byrne-hobart) & [Tobias Huber](/notes/tobias-huber) — authors of Boom (Stripe Press); the Schumpeterian bubbles-leave-infrastructure argument Danny presses on.
- [Palmer Luckey](/notes/palmer-luckey) — "human inertia is the biggest limiter to AGI/ASI."

**Books**
- Freedom's Forge — the WWII reindustrialization history on Kyle's shelf; used to argue reindustrialization is precedented but "uncomprehensibly more complex" today (cost-plus contracting, [Ford](/notes/henry-ford) building tanks).
- Boom — Hobart & Huber on bubbles, capital destruction, and the infrastructure they leave behind (railroads → fiber → AI).

**Concepts & themes**
- [Creative destruction](/notes/creative-destruction) / Schumpeter — why it breaks down under fabrication-scale barriers to entry.
- Ecosystem development / tacit knowledge — apprentice-based skills (shipbuilding, steel, Detroit autos, chips) that don't survive a lost generation.
- Cognitive security / information commons — Kyle's stated bigger fear than industrial complexity; trust, incentives, and the "rally to the flag" that 2025 may no longer be capable of.
- Hype as currency / attention economics — the "never-ending con," green bubble 2.0, and capital-destruction risk to Alzheimer's research, cancer research, robotics.
- Good enough AI · [AGI](/notes/agi) / ASI — efficiency vs. the AGI narrative; energy-market spending as revealed belief.
- Technological distribution curve — Kyle's optimistic thesis: distribute existing tech to the long-tail (Magnificent 7 vs. the other 493); "ChatGPT was a distribution breakthrough, not a technological one."
- US–China competition / Taiwan — the five-year conflict time-series driving urgency; "parity" as a sufficient defense goal.
- Riskgaming — Lux's scenario games (e.g. "Deepfake & DeepSeek," the bioenhancements information-commons beta).
